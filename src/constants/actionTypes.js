...
export const SET_CHART_DATASET_TYPE = "SET_CHART_DATASET_TYPE";
export const CLEAR_CHART_TRACKS_SELECTED = "CLEAR_CHART_TRACKS_SELECTED";
export const SET_CHART_SATELLITE_CHART_TYPE = "SET_CHART_SATELLITE_CHART_TYPE";
export const SET_CDMS_CHARTING_OPTIONS = "SET_CDMS_CHARTING_OPTIONS";
export const SET_CDMS_TRACK_SELECTED = "SET_CDMS_TRACK_SELECTED";
...
export const SET_SATELLITE_SEARCH_FACETS = "SET_SATELLITE_SEARCH_FACETS";
export const SET_SEARCH_FACET_SELECTED = "SET_SEARCH_FACET_SELECTED";
export const SET_SATELLITE_SEARCH_FACET_SELECTED = "SET_SATELLITE_SEARCH_FACET_SELECTED";
export const CLEAR_TRACK_SEARCH_FACET = "CLEAR_TRACK_SEARCH_FACET";
export const CLEAR_SATELLITE_SEARCH_FACET = "CLEAR_SATELLITE_SEARCH_FACET";
...
// Help stuff
export const SET_HELP_PAGE_KEY = "SET_HELP_PAGE_KEY";
