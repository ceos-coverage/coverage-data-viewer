...
export const CHART_TYPES = {
    ...
    SINGLE_SERIES_WITH_SUMMARY: "SINGLE_SERIES_WITH_SUMMARY",
};
...
export const LAYER_VECTOR_POINT_TRACK = "vector_tile_points";
...
export const DAG_DATA_FORMAT = "DAG_DATA_FORMAT";
export const WORKER_TASK_FORMAT_DAG_DATA = "WORKER_TASK_FORMAT_DAG_DATA"; // lol
export const CDMS_DATA_FORMAT = "CDMS_DATA_FORMAT";
export const WORKER_TASK_FORMAT_CDMS_DATA = "WORKER_TASK_FORMAT_CDMS_DATA"; // lol

export const CHART_DATASET_TYPE_INSITU = "In-Situ";
export const CHART_DATASET_TYPE_SATELLITE = "Satellite";
export const CHART_DATASET_TYPE_CDMS = "CDMS Matchup";
export const SATELLITE_CHART_TYPE_TIME_SERIES = "SATELLITE_CHART_TYPE_TIME_SERIES";
export const SATELLITE_CHART_TYPE_TIME_RANGE_HIST = "SATELLITE_CHART_TYPE_TIME_RANGE_HIST";
