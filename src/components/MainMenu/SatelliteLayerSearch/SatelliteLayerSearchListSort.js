...
import styles from "components/MainMenu/SatelliteLayerSearch/SatelliteLayerSearchListSort.scss";

export class SatelliteLayerSearchListSort extends Component {
    render() {
        return (
...
SatelliteLayerSearchListSort.propTypes = {
