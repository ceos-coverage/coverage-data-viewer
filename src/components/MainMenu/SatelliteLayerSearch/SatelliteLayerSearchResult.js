...
import styles from "components/MainMenu/SatelliteLayerSearch/SatelliteLayerSearchResult.scss";

export class SatelliteLayerSearchResult extends Component {
    handleSelect() {
    ...
    render() {
        ...
        let secondaryText = <span>{startStr + " – " + endStr}</span>;
...
SatelliteLayerSearchResult.propTypes = {
