/**
 * @license Highcharts JS v6.0.3-modified (2017-11-21)
 * Boost module
 *
...
(function(factory) {
    ...
    (function(H) {
        ...
        function shouldForceChartSeriesBoosting(chart) {
            ...
            allowBoostForce = chart.options.boost
                ? typeof chart.options.boost.allowForce !== "undefined"
                  ? chart.options.boost.allowForce
                  : allowBoostForce
                : allowBoostForce;
        ...
        Chart.prototype.isChartSeriesBoosting = function() {
            ...
            threshold =
                this.options.boost && typeof this.options.boost.seriesThreshold !== "undefined"
                    ? this.options.boost.seriesThreshold
                    : threshold;

            return threshold <= this.series.length || shouldForceChartSeriesBoosting(this);
        };
        ...
        function GLRenderer(postRenderCallback) {
            ...
            function pushSeriesData(series, inst) {
                var isRange = series.pointArrayMap && series.pointArrayMap.join(",") === "low,high",
                    ...
                    // getColor = series.options.getColor,
                ...
                while (i < sdata.length - 1) {
                    ...
                    //     var tmpColor = getColor(rawData[i]);
                    //     pcolor = [tmpColor.r / 255, tmpColor.g / 255, tmpColor.b / 255, tmpColor.a];
                    // }
                    ...
                    // // Uncomment this to support color axis.
                    // if (caxis) {
                    //     color = H.color(caxis.toColor(zData[i])).rgba;
                    //     // color = H.color(caxis.toColor(y)).rgba;
        ...
        wrap(Series.prototype, "processData", function(proceed) {
            ...
            if (
                ...
                if (typeof this.options.data[0] !== "undefined") {
                    ...
                    if (length > 2) {
                        this.processedZData = this.zData = this.options.data.map(function(entry) {
                            return entry[2];
                        });
                    }
                }
